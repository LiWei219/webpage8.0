  ...
  success: function (jsonArray){
	...
	var alld=[];
   		...
   		//{
   			...
   			alld[0] = parseInt(jsonArray[0]);
alld[1] = parseInt(jsonArray[1]);

alld[2] = parseInt(jsonArray[2]);

alld[3] = parseInt(jsonArray[3]);

alld[4] = parseInt(jsonArray[4]);

alld[5] = parseInt(jsonArray[5]);

alld[6] = parseInt(jsonArray[6]);

alld[7] = parseInt(jsonArray[7]);

alld[8] = parseInt(jsonArray[8]);

alld[9] = parseInt(jsonArray[9]);
